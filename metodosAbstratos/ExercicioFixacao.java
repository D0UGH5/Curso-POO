...
public class ExercicioFixacao {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; i++) {
            System.out.printf("Dados do(a) %dº contribuinte: \n", i);
            ...
            if(ch == 'F'){
                System.out.print("Quanto foi gasto com saúde? ");
        ...
        for (Pessoa p : lista) {
            System.out.printf("O valor de imposto pago pelo(a) %s contribuinte é %.2f\n", p.getNome(), p.imposto());
            totalDeImpostos += p.imposto();
        }
