Em um portal de cursos online, cada curso possui um código único, representado por um número inteiro .
...
O instrutor Alex possui três cursos A, B e C, e deseja savber seu número total de alunos.
